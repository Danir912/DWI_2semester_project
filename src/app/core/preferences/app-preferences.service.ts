...
const DICTIONARY: Record<AppLanguage, Record<string, string>> = {
  ru: {
    ...
    delete: 'Удалить',
    type: 'Тип',
    addInteraction: 'Добавить взаимодействие',
    interactionCall: 'Звонок',
    interactionMeeting: 'Встреча',
    interactionEmail: 'Письмо',
    ...
    date: 'Дата',
    record: 'Записать',
    recordInteraction: 'Записать взаимодействие',
    ...
    remindersDescription:
      'Все follow-up задачи по контактам. Выполненные напоминания хранятся 7 дней после закрытия.',
    pendingCount: 'Ожидает',
    notesDescription: 'Общие заметки по контактам, собранные в одном разделе.',
    notesCount: 'Заметок',
    noNotes: 'Заметок пока нет',
    trashDescription:
      'Удалённые контакты хранятся 7 дней. На этой странице их можно восстановить или удалить навсегда.',
  ...
  en: {
    ...
    remindersDescription:
      'All follow-up tasks by contact. Completed reminders are kept for 7 days after closing.',
    pendingCount: 'Pending',
    notesDescription: 'General contact notes collected in one workspace.',
    notesCount: 'Notes',
    noNotes: 'No notes yet',
    trashDescription:
      'Deleted contacts are kept for 7 days. Restore them or delete them permanently here.',
    restore: 'Restore',
